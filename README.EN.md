...
[English](https://zengzichao.github.io/Rclade/README.EN.md) \|
[中文](https://zengzichao.github.io/Rclade/README.CN.md)

[![R
package](https://img.shields.io/badge/R-package-blue.svg)](https://www.r-project.org/)
[![License:
MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Version](https://img.shields.io/badge/version-1.1.3-green.svg)](https://zengzichao.github.io/Rclade/)

> **Note:** Source code and issue tracking at
> <https://github.com/zengzichao/Rclade>. Install from the source
> tarball as shown below, or clone the GitHub repository.

Rclade provides a single-function pipeline for automated collapsing and
visualization of large phylogenetic trees with geological timescales. It
is designed for **deep-time phylogenomics** and **microbial evolution
studies**, enabling researchers to visualize taxonomic relationships
across geological time scales (Ga/Ma) with automatic clade collapsing
based on GTDB, Silva, or NCBI taxonomy.
...
- 中文文档总览：[inst/docs/cn/index.md](https://zengzichao.github.io/Rclade/inst/docs/cn/index.md)
- English
  documentation：[inst/docs/en/index.md](https://zengzichao.github.io/Rclade/inst/docs/en/index.md)
- 函数参考（中文）：[inst/docs/cn/reference/index.md](https://zengzichao.github.io/Rclade/inst/docs/cn/reference/index.md)
- Function reference
  (EN)：[inst/docs/en/reference/index.md](https://zengzichao.github.io/Rclade/inst/docs/en/reference/index.md)

## Features

- **Automatic taxonomy parsing**: Detects GTDB, Silva, NCBI, and custom
  label formats via heuristic prefix matching
- **Dual-format taxonomy**: Format A (embedded `_d_Bacteria_...`) with
  reverse matching, Format B (semicolon `d__Bacteria;...`) with value
  validation
- **Batch clade collapsing**: Nesting-aware depth-first ordering with
  automatic conflict detection
- **Clade-specific collapsing**: `--clade` option to collapse a specific
  clade with monophyly check
- **Geological timescale integration**: Adaptive time breaks (Ma/Ka) via
  deeptime with ICS 2023/02 chronostratigraphy
- **Smart legend layout**: Auto-adjusting rows/columns for any number of
  groups
- **Publication-ready output**: Color-blind-safe palettes (viridis
  default), high-resolution PDF/PNG/SVG/TIFF/EPS
- **Special ancestral node identifiers**: LUCA, LACA, LBCA, ROOT for
  highlighting key nodes
- **External taxonomy file support**: Read taxonomy from external file
  with circular dependency detection
- **Tree-sequence cross-validation**: Automatic tip label vs sequence ID
  matching
- **Real-time logging**: ISO 8601 timestamps with milliseconds, step
  tracking, log file output
- **Comprehensive input validation**: Deep tree/sequence validation,
  PHYLIP/Stockholm rejection
- **Cross-platform robustness**: UTF-8 encoding, BOM handling, newline
  normalization
- **Graceful interrupt handling**: Ctrl+C with progress report and
  resource cleanup
- **Adversarial input protection**: Control character/BiDi detection,
  empty file rejection
- **Self-test mode**: `--check` validates dependencies, parsing, and
  monophyly logic
- **Multiple interfaces**: R API, CLI
  ([`run_rclade_cli()`](https://zengzichao.github.io/Rclade/reference/run_rclade_cli.md)
  / `inst/bin/rclade` wrapper script), and Shiny web app
...
> **Reproducibility note**: `environment.yml` specifies minimum version
> bounds. For fully reproducible environments, export an explicit spec
> after creation:
>
> ``` bash
...
|----|----|
| [`plot_timetree()`](https://zengzichao.github.io/Rclade/reference/plot_timetree.md) | Main entry point: collapse + visualize in one call |
| [`rclade_options()`](https://zengzichao.github.io/Rclade/reference/rclade_options.md) | Build a validated options list for `plot_timetree(opts = ...)` |
| [`save_timetree()`](https://zengzichao.github.io/Rclade/reference/save_timetree.md) | Export to PDF/PNG/SVG/TIFF/EPS with overwrite control |
| [`batch_plot()`](https://zengzichao.github.io/Rclade/reference/batch_plot.md) | Batch-plot all tree files in a directory |
| [`summarize_timetree()`](https://zengzichao.github.io/Rclade/reference/summarize_timetree.md) | Print collapse metadata |
| [`summarize_taxonomy_quality()`](https://zengzichao.github.io/Rclade/reference/summarize_taxonomy_quality.md) | Report label parsing quality |
| [`summarize_taxonomy_quality_with_file()`](https://zengzichao.github.io/Rclade/reference/summarize_taxonomy_quality_with_file.md) | Report quality with external file |
| [`check_monophyly()`](https://zengzichao.github.io/Rclade/reference/check_monophyly.md) | Check if a group is monophyletic |
| [`check_special_monophyly()`](https://zengzichao.github.io/Rclade/reference/check_special_monophyly.md) | Check if LUCA/LACA/LBCA is monophyletic |
| [`detect_taxonomy_format()`](https://zengzichao.github.io/Rclade/reference/detect_taxonomy_format.md) | Detect taxonomy label format (GTDB/Silva/NCBI/embedded) |
| [`parse_taxonomy()`](https://zengzichao.github.io/Rclade/reference/parse_taxonomy.md) | **Library-mode API**: parse taxonomy from tip labels, returns a data.frame |
| [`read_tree_auto()`](https://zengzichao.github.io/Rclade/reference/read_tree_auto.md) | **Library-mode API**: auto-detect format and read a tree file (for external workflows) |
| [`read_taxonomy_file()`](https://zengzichao.github.io/Rclade/reference/read_taxonomy_file.md) | Read taxonomy from external file |
| [`validate_sequence_deep()`](https://zengzichao.github.io/Rclade/reference/validate_sequence_deep.md) | Deep sequence file validation |
| [`validate_sequence_file()`](https://zengzichao.github.io/Rclade/reference/validate_sequence_file.md) | Validate sequence file format |
| [`validate_tree_sequence_match()`](https://zengzichao.github.io/Rclade/reference/validate_tree_sequence_match.md) | Cross-validate tree tips vs sequence IDs |
| [`theme_timetree()`](https://zengzichao.github.io/Rclade/reference/theme_timetree.md) | Publication-ready ggplot2 theme |
| [`run_rclade_selftest()`](https://zengzichao.github.io/Rclade/reference/run_rclade_selftest.md) | Run comprehensive self-test |
| [`run_rclade_shiny()`](https://zengzichao.github.io/Rclade/reference/run_rclade_shiny.md) | Launch interactive Shiny web app |
| [`save_session_info()`](https://zengzichao.github.io/Rclade/reference/save_session_info.md) | Export sessionInfo for reproducibility |
| [`set_log_level()`](https://zengzichao.github.io/Rclade/reference/set_log_level.md) | Set logging level (DEBUG/INFO/WARNING/ERROR/CRITICAL) |
| [`set_log_file()`](https://zengzichao.github.io/Rclade/reference/set_log_file.md) | Enable log file output |
| [`set_log_enabled()`](https://zengzichao.github.io/Rclade/reference/set_log_enabled.md) | Enable or disable logging |
| [`rclade_logo()`](https://zengzichao.github.io/Rclade/reference/rclade_logo.md) | Display ASCII art logo |
| [`get_supported_extensions()`](https://zengzichao.github.io/Rclade/reference/get_supported_extensions.md) | List supported file extensions |

### Internal Utility Functions

The following infrastructure helpers are **internal** (not exported) as
of the export-surface convergence; access them with `Rclade:::` if
needed:

| Function | Description |
|----|----|
| [`batch_with_interrupt()`](https://zengzichao.github.io/Rclade/reference/batch_with_interrupt.md) | Batch processing with graceful Ctrl+C handling; returns partial results list on interrupt |
| [`build_path()`](https://zengzichao.github.io/Rclade/reference/build_path.md) | Cross-platform safe path construction |
| [`managed_tempdir()`](https://zengzichao.github.io/Rclade/reference/managed_tempdir.md) / [`managed_tempfile()`](https://zengzichao.github.io/Rclade/reference/managed_tempfile.md) | Temporary resources with automatic cleanup |
| [`normalize_file_newlines()`](https://zengzichao.github.io/Rclade/reference/normalize_file_newlines.md) | Normalize line endings in a file |
| [`log_debug()`](https://zengzichao.github.io/Rclade/reference/log_debug.md) / [`log_info()`](https://zengzichao.github.io/Rclade/reference/log_info.md) / [`log_warning()`](https://zengzichao.github.io/Rclade/reference/log_warning.md) / [`log_error()`](https://zengzichao.github.io/Rclade/reference/log_error.md) / [`log_critical()`](https://zengzichao.github.io/Rclade/reference/log_critical.md) | Real-time logging helpers |
| [`log_section()`](https://zengzichao.github.io/Rclade/reference/log_section.md) / [`log_subsection()`](https://zengzichao.github.io/Rclade/reference/log_subsection.md) / [`log_keyvalue()`](https://zengzichao.github.io/Rclade/reference/log_keyvalue.md) / [`log_progress()`](https://zengzichao.github.io/Rclade/reference/log_progress.md) / [`log_stats()`](https://zengzichao.github.io/Rclade/reference/log_stats.md) / [`log_table()`](https://zengzichao.github.io/Rclade/reference/log_table.md) | Formatted log output |
| [`timer_start()`](https://zengzichao.github.io/Rclade/reference/timer_start.md) / [`timer_stop()`](https://zengzichao.github.io/Rclade/reference/timer_stop.md) | Performance timing helpers |
| [`with_graceful_interrupt()`](https://zengzichao.github.io/Rclade/reference/with_graceful_interrupt.md) | Wrap expression with graceful SIGINT handling |
| [`resolve_special_identifier()`](https://zengzichao.github.io/Rclade/reference/resolve_special_identifier.md) / [`resolve_group()`](https://zengzichao.github.io/Rclade/reference/resolve_group.md) | Special-identifier / group resolvers |
| [`validate_custom_groups()`](https://zengzichao.github.io/Rclade/reference/validate_custom_groups.md) / [`validate_taxonomy_no_cycles()`](https://zengzichao.github.io/Rclade/reference/validate_taxonomy_no_cycles.md) | Group / taxonomy validators |
| [`generate_colors()`](https://zengzichao.github.io/Rclade/reference/generate_colors.md) | Color-blind-safe palette generation |
| [`split_legend()`](https://zengzichao.github.io/Rclade/reference/split_legend.md) | Extract legend as separate panel |
| [`detect_encoding()`](https://zengzichao.github.io/Rclade/reference/detect_encoding.md) | Detect file encoding (UTF-8, BOM, etc.) |
...
Correctly propagates exit codes 0/1/2/3 - Returns the standard Unix exit
code **130** on Ctrl+C (SIGINT) interruption - Uses the same CLI
arguments
...
Rclade supports YAML configuration files for supplying defaults.
Precedence: **explicit CLI flags \> config file \> built-in defaults**.
The package ships a `config.example.yaml` template listing all
configurable options; access it with:
...
Example config (see `inst/extdata/config.example.yaml` for the full
template):
...
> Note: optparse cannot distinguish “user explicitly passed the default
> value” from “user did not pass the flag”. If you explicitly pass a
> value equal to the built-in default, the config value will still take
> effect. To force a setting over the config file, pass it explicitly on
> the CLI.
...
- **Node numbering**: Internal nodes are 1-indexed (root = Ntip + 1),
  following `ape` convention
...
- **Standard compliance**: Newick format per [Newick
  standard](https://evolution.genetics.washington.edu/phylip/newicktree.html),
  Nexus per [NEXUS standard](https://doi.org/10.1093/sysbio/46.4.590)
...
| Consensus | `.con`, `.confile` | Treated as Newick (parsed with [`ape::read.tree()`](https://rdrr.io/pkg/ape/man/read.tree.html)) |
...
**Rejected formats** (with informative error): - PHYLIP format -
Stockholm format

### Taxonomy File Format

External taxonomy files should have two columns: 1. Tip label (must
match tree) 2. Taxonomy string in GTDB format
...
Missing ranks indicated by empty value after prefix: `s__` (species
missing)
...
| 130 | User interrupt | Ctrl+C (SIGINT) received during execution; [`run_rclade_cli()`](https://zengzichao.github.io/Rclade/reference/run_rclade_cli.md) returns 130, and the `inst/bin/rclade` wrapper guarantees stable propagation to 130 in terminal sessions |

> Note:
> [`run_rclade_cli()`](https://zengzichao.github.io/Rclade/reference/run_rclade_cli.md)
> now uses `tryCatch` to catch interrupts and return 130, so it should
> return 130 both in interactive R and when the session ends with
> `q(status = run_rclade_cli(...))`. However, for complex signal
> scenarios or plain `Rscript -e` calls, we still recommend using the
> provided `inst/bin/rclade` wrapper, which forwards SIGINT directly
> from the shell and returns 130.
...
Logging functions
([`log_info()`](https://zengzichao.github.io/Rclade/reference/log_info.md)
/
[`log_warning()`](https://zengzichao.github.io/Rclade/reference/log_warning.md)
/
[`log_error()`](https://zengzichao.github.io/Rclade/reference/log_error.md),
etc.) accept an optional `.module` argument that inserts a
`[MODULE/FUNCTION]` source tag into warning/error messages, making it
...
Checks: dependencies, tree parsing, taxonomy extraction (Format A & B),
monophyly logic, input validation, adversarial inputs.
...
**Required**: ape (\>= 5.0, GPL-2+), ggtree (\>= 4.0.0, Artistic-2.0),
deeptime (\>= 1.0, GPL-3), ggplot2 (\>= 3.5.0, MIT), rlang (MIT),
stringr (\>= 1.5, MIT), tidytree (\>= 0.4, Artistic-2.0)

**Optional**: treeio (Artistic-2.0, BEAST2/IQ-TREE support), phangorn
(GPL-2+, nesting detection), viridisLite/RColorBrewer (color palettes),
cowplot/patchwork (legend splitting), shiny (web UI), optparse (CLI),
yaml (`--config` configuration file support)

For a complete list of third-party dependencies and their licenses, see
[inst/THIRDPARTY](https://zengzichao.github.io/Rclade/inst/THIRDPARTY).
...
> geological-timescale annotation of time-calibrated phylogenetic trees
> in R. bioRxiv. <doi:10.64898/2026.08.27.747462>

Rclade builds on the ggtree and deeptime ecosystems. Please also cite
these key dependencies:
...
Contributions are welcome! Please submit via GitHub Issue or Pull
Request:
...
See
[CONTRIBUTING.EN.md](https://zengzichao.github.io/Rclade/CONTRIBUTING.EN.md)
for details.
...
- **ICS geological timescale data** (`R/sysdata.rda`): based on the [ICS
  International Chronostratigraphic Chart
  2023/02](https://stratigraphy.org/chart). Geological boundary ages are
  factual data.
