...
> **说明：** GitHub 仓库位于
> [https://github.com/zengzichao/Rclade，欢迎提交](https://github.com/zengzichao/Rclade%EF%BC%8C%E6%AC%A2%E8%BF%8E%E6%8F%90%E4%BA%A4)
...
报告 bug 时，请包含： - 最小可复现示例 - 您的 R
会话信息（[`sessionInfo()`](https://rdrr.io/r/utils/sessionInfo.html)） -
预期行为与实际行为
...
- 如果用户可见行为发生变化，请同时更新 `README.EN.md` 和
  `README.CN.md`。
- 重要变更请更新 `NEWS.EN.md` 和 `NEWS.CN.md`。
- 修改 roxygen 注释后，使用 `devtools::document()` 重新生成 `man/`
  页面。
